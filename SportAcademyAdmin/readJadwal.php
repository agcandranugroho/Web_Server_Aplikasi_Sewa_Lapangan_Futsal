<?php
   ...
   $result = mysqli_query($conn,"SELECT pemesanan.*,lapangan.*, pembayaran.* FROM pemesanan JOIN lapangan ON pemesanan.id_lapangan=lapangan.id_lapangan JOIN pembayaran ON pemesanan.id_pemesanan=pembayaran.id_pemesanan WHERE pembayaran.status='sudah bayar' ORDER BY tanggal_main");
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
              <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Jadwal Main</h1>
                  </div><!-- /.col -->
                </div><!-- /.row -->
              </div><!-- /.container-fluid -->
            </div>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    {         
                                        ...
                                        echo "<td>".$hasil['durasi_start'].':'."00"."</td>";
                                        echo "<td>".$hasil['durasi_end'].':'."00"."</td>";
                                    }
                                ?>
                            </tbody>
                        </table>
