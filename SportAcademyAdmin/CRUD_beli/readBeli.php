    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <a class="btn badge-info" href='https://canlup.000webhostapp.com/SportAcademyAdmin/CRUD_beli/formTambah.php'>Tambah Data +</a>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    {   
                                        ...
                                        $harga_beli = number_format($hargaBeli,0,",",".");
                                ...
                                ?>
                                        <tr>
                                        <td><?php echo $no++ ?></td>
                                        <td><?php echo $hasil['nama_item']?> </td> 
                                        <td><?php echo $hasil['jumlah']?> </td>
                                        <td><?php echo 'Rp'.$harga_beli ?></td>
                                        <td><?php echo $hasil['merek']?> </td>
                                        <td><?php echo $hasil['tanggal_beli']?></td>
                                        <td><?php echo 'Rp'.$total_harga ?></td>
                                           
                                        <td>
                                                <a class='btn btn-danger btn-sm' href='https://canlup.000webhostapp.com/SportAcademyAdmin/CRUD_beli/fungsiDelete.php?id=<?php echo $hasil['id_pembelian']?>'>
                                                    <i class='fas fa-trash-alt'></i> Delete
                                                </a>
                                                
                                                <a class='btn btn-info btn-sm' href='https://canlup.000webhostapp.com/SportAcademyAdmin/CRUD_beli/formUpdate.php?id=<?php echo  $hasil['id_pembelian']?>'> 
