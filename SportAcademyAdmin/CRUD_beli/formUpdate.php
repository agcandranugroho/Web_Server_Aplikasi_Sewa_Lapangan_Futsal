    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php 
                include '../conn.php';
                $id = $_GET['id'];
                $data = mysqli_query($conn,"SELECT * FROM pembelian WHERE id_pembelian='$id'");
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Update Data Pembelian</h3>
                            </div>
                            <!-- /.card-header -->  
                            <!-- form start -->
                            <form action="fungsiUpdate.php" method="POST">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="id" value="<?php echo $hasil['id_pembelian']; ?>">
                                        <input type="text" class="form-control" name="nama_item" value ="<?php echo $hasil['nama_item']; ?>">
                                    </div>
                                
                                    <div class="form-group">
                                        <label>Harga/Satuan</label>
                                        <input type="text" class="form-control" name="harga" value="<?php echo $hasil['harga_beli']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Merek</label>
                                        <input type="text" class="form-control" name="merek" value="<?php echo $hasil['merek']; ?>">
                                    </div>
                                    
                                     <div class="form-group">
                                        <label>Tanggal Beli</label>
                                        <input type="text" id="date" class="form-control" name="tanggal" value="<?php echo $hasil['tanggal_beli']; ?>">
                                    </div>
