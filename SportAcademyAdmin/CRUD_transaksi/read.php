<?php
    ...
    $result = mysqli_query($conn,"SELECT pemesanan.*, pembayaran.*, lapangan.nama AS nama_lapangan, users.* FROM pemesanan JOIN pembayaran ON pemesanan.id_pemesanan=pembayaran.id_pemesanan JOIN lapangan ON pemesanan.id_lapangan=lapangan.id_lapangan JOIN users ON pemesanan.id_pelanggan=users.id_user");
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
              <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Daftar Pemesanan Lapangan</h1>
                  </div><!-- /.col -->
                </div><!-- /.row -->
              </div><!-- /.container-fluid -->
            </div>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    {   
                                        ...
                                        echo "<tr>";
                                        echo "<td>".$no++."</td>";
                                        echo "<td>".$hasil['id_pemesanan']."</td>";
                                        echo "<td>".$hasil['id_bayar']."</td>"; 
                                        echo "<td>".$hasil['nama']."</td>";
                                        echo "<td>".$hasil['nama_lapangan']."</td>";
                                        echo "<td>".$hasil['durasi_start']."</td>";
                                        echo "<td>".$hasil['durasi_end']."</td>";
                                        echo "<td>".$hasil['tanggal_main']."</td>";
                                        echo "<td>".$hasil['tanggal_pesan']."</td>";
                                        echo "<td>".$hasil['status']."</td>";
                                           
                                        //button delete
                                        echo "<td>
                                                <a class='btn btn-danger btn-sm' href='https://canlup.000webhostapp.com/SportAcademyAdmin/CRUD_admins/fungsiDelete.php?id=".$hasil['id_pemesanan']."'>
