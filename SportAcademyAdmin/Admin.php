                ...
                <div class="row">
                	...
                	<div class="col-lg-3 col-6">
                        <div class="small-box bg-blue">
                          ...
                          <a href="https://canlup.000webhostapp.com/SportAcademyAdmin/CRUD_admins/readAdmin.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <!-- user admins -->
