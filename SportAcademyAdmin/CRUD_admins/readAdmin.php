<?php
    ...
    if(isset($_SESSION["admins"])){
        ...
        $result = mysqli_query($conn,"SELECT * FROM admins");
         ...
         header("location:https://canlup.000webhostapp.com/halaman.html");
    }
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <a class="btn badge-info" href='https://canlup.000webhostapp.com/SportAcademyAdmin/CRUD_admins/formTambah.php'>Tambah Data +</a>
                        <a class="btn badge-warning" href='https://canlup.000webhostapp.com/SportAcademyAdmin/CRUD_admins/formTambahGaji.php'>Penggajian Karyawan</a>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    {   
                                      ...
                                      echo "<td>
                                                <a class='btn btn-danger btn-sm' href='https://canlup.000webhostapp.com/SportAcademyAdmin/CRUD_admins/fungsiDelete.php?id=".$hasil['id_admin']."'>
                                                    <i class='fas fa-trash-alt'></i> Delete
                                                </a>
                                                
                                                <a class='btn btn-info btn-sm' href='https://canlup.000webhostapp.com/SportAcademyAdmin/CRUD_admins/formUpdate.php?id=".$hasil['id_admin']."'> 
