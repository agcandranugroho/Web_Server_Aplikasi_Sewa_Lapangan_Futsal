    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php 
                include '../conn.php';
                $id=$_GET['id'];
                $data = mysqli_query($conn,"SELECT * FROM admins WHERE id_admin='$id'");
                ...
                <!-- left column -->
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->  
                            <!-- form start -->
                            <form action="fungsiUpdate.php" method="POST">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Nama</label>
                                        <input type="hidden" name="id_admin" value="<?php echo $hasil['id_admin']; ?>" required>
                                        <input type="text" class="form-control" name="nama" value ="<?php echo $hasil['nama']; ?>" required>
                                    </div>
                                
                                    <div class="form-group">
                                        <label>Username</label>
                                        <input type="text" class="form-control" name="username" value="<?php echo $hasil['username']; ?>" required>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="email" class="form-control" name="email" value="<?php echo $hasil['email']; ?>" required>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>No Telpon</label>
                                        <input type="number" class="form-control" name="no_hp" value="<?php echo $hasil['no_hp']; ?>" required>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>Gaji</label>
                                        <input type="number" class="form-control" name="gaji" value="<?php echo $hasil['gaji']; ?>" required>
                                    </div>
                            
                                <div class="card-footer">
                                    <button class="btn btn-primary" type="submit" name="simpan" value="simpan">Simpan Perubahan</button>
