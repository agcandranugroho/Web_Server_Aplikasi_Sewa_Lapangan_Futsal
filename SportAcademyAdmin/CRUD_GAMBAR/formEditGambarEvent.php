    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php 
                include '../conn.php';
                $id = $_GET['id'];
                $data = mysqli_query($conn,"SELECT * FROM gambar WHERE id='$id'");
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Update Data Event</h3>
                            </div>
                            <!-- /.card-header -->  
                            <!-- form start -->
                            <img src="<?php echo $hasil['img']; ?>" width="100"/>
                            <form action="fungsiUpdate.php" method="POST">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Keterangan</label>
                                        <input type="hidden" name="id" value="<?php echo $hasil['id']; ?>"></br>
                                        <textarea class="form-control" name="keterangan" value ="" >
